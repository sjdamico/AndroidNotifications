...
public class NotificationActivity extends AppCompatActivity
    ...
    private void createNotification() {
        ...
        // TODO: Set the content intent to launch our result activit(pendingIntenty
        ...
        // Use this line to put all of the notification on the lock screen
        // builder.notification(Notification.VISIBILITY_PUBLIC);

        // Use this line to put only the icon and title of the notification on the lock screen
        builder.setVisibility(Notification.VISIBILITY_PRIVATE);

        // Use this line to keep the notification off the lock screen
        // builder.notification(Notification.VISIBILITY_SECRET);
